...
namespace Paulov.Tarkov.WebServer.DOTNET.Controllers
{
    public class HideoutController : Controller
    {
        ...
        {
            DatabaseHelpers.TryLoadDatabaseFile(Path.Combine("hideout", "areas.json"), out JArray jobj);
        ...
        {
            DatabaseHelpers.TryLoadDatabaseFile(Path.Combine("hideout", "qte.json"), out JArray jobj);
        ...
        {
            DatabaseHelpers.TryLoadDatabaseFile(Path.Combine("hideout", "settings.json"), out JObject jobj);
        ...
        {
            DatabaseHelpers.TryLoadDatabaseFile(Path.Combine("hideout", "production.json"), out JObject jobj);
        ...
        {
            DatabaseHelpers.TryLoadDatabaseFile(Path.Combine("hideout", "customisation.json"), out JObject jobj);
