...
namespace BSGHelperLibrary
{
    ...
    public static class ReflectionHelpers
    {
        ...
        public static object GetValueOfJsonProperty(object ob, string name)
        {
            ...
            var field = ob.GetType().GetFields(System.Reflection.BindingFlags.Instance | System.Reflection.BindingFlags.NonPublic).FirstOrDefault(x => ((JsonPropertyAttribute)x.GetCustomAttribute(typeof(JsonPropertyAttribute))).PropertyName == name);
            if (field != null)
            {
            ...
            // Public Field
            field = ob.GetType().GetFields(System.Reflection.BindingFlags.Instance | System.Reflection.BindingFlags.Public).FirstOrDefault(x => ((JsonPropertyAttribute)x.GetCustomAttribute(typeof(JsonPropertyAttribute))).PropertyName == name);
            if (field != null)
            {
                return field.GetValue(ob);
            }
            ...
            var property = ob.GetType().GetProperties(System.Reflection.BindingFlags.Instance | System.Reflection.BindingFlags.NonPublic).FirstOrDefault(x => ((JsonPropertyAttribute)x.GetCustomAttribute(typeof(JsonPropertyAttribute))).PropertyName == name);
            if (property != null)
            {
                return property.GetValue(ob);
            }

            // Public Property
            property = ob.GetType().GetProperties(System.Reflection.BindingFlags.Instance | System.Reflection.BindingFlags.Public).FirstOrDefault(x => ((JsonPropertyAttribute)x.GetCustomAttribute(typeof(JsonPropertyAttribute))).PropertyName == name);
            if (property != null)
            {
                return property.GetValue(ob);
            }
        ...
        public static void SetValueOfJsonProperty(object ob, string name, object value)
        {
            // Private / Protected Field
            var field = ob.GetType().GetFields(System.Reflection.BindingFlags.Instance | System.Reflection.BindingFlags.NonPublic).FirstOrDefault(x => x.CustomAttributes.Any() && ((JsonPropertyAttribute)x.GetCustomAttribute(typeof(JsonPropertyAttribute)))?.PropertyName == name);
            if (field != null)
            {
            ...
            // Public Field
            field = ob.GetType().GetFields(System.Reflection.BindingFlags.Instance | System.Reflection.BindingFlags.Public).FirstOrDefault(x => x.CustomAttributes.Any() && ((JsonPropertyAttribute)x.GetCustomAttribute(typeof(JsonPropertyAttribute)))?.PropertyName == name);
            if (field != null)
            {
                field.SetValue(ob, value);
            }
            ...
            // Private / Protected Property
            var property = ob.GetType().GetProperties(System.Reflection.BindingFlags.Instance | System.Reflection.BindingFlags.NonPublic).FirstOrDefault(x => x.CustomAttributes.Any() && ((JsonPropertyAttribute)x.GetCustomAttribute(typeof(JsonPropertyAttribute)))?.PropertyName == name);
            if (property != null)
            {
            ...
            // Public Property
            property = ob.GetType().GetProperties(System.Reflection.BindingFlags.Instance | System.Reflection.BindingFlags.Public).FirstOrDefault(x => x.CustomAttributes.Any() && ((JsonPropertyAttribute)x.GetCustomAttribute(typeof(JsonPropertyAttribute)))?.PropertyName == name);
            if (property != null)
            {
                property.SetValue(ob, value);
            }
